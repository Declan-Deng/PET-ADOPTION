...
export const UserProvider = ({ children }) => {
  ...
  const login = async (username, password) => {
    try {
      ...
      const response = await fetch(
        "http://192.168.31.232:5001/api/auth/login",
        {
          method: "POST",
          headers: {
  ...
  const register = async (userData) => {
    try {
      const response = await fetch(
        "http://192.168.31.232:5001/api/auth/register",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    try {
      ...
      if (
        ...
        const uploadResponse = await fetch(
          "http://192.168.31.232:5001/api/upload/avatar",
          {
            method: "POST",
            headers: {
      ...
      // 发送更新请求
      const response = await fetch(
        "http://192.168.31.232:5001/api/auth/profile",
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const addPublication = async (publication) => {
    try {
      ...
      // 发送请求到后端
      const response = await fetch("http://192.168.31.232:5001/api/pets", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const addAdoption = async (adoptionData) => {
    try {
      ...
      const submitResponse = await fetch(
        "http://192.168.31.232:5001/api/adoptions",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const cancelAdoption = async (adoptionId) => {
    try {
      ...
      // 发送取消请求
      const response = await fetch(
        `http://192.168.31.232:5001/api/adoptions/${adoptionId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
