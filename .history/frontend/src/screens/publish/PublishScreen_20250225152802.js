              ...
              {formData.petType === "other" ? (
                <>
                  <View style={styles.breedContainer}>
                    <Text style={styles.breedLabel}>动物类型</Text>
                    <RadioButton.Group
                      onValueChange={(value) => {
                        const selectedType = otherPetTypes.find(
                          (type) => type.value === value
                        );
                        handleOtherPetTypeSelect(selectedType);
                      }}
                      value={formData.otherType}
                    >
                      <View style={styles.breedScroll}>
                ...
                <>
                  <View style={styles.breedContainer}>
                    <Text style={styles.breedLabel}>品种</Text>
                    <RadioButton.Group
                      onValueChange={(value) => {
                        const selectedBreed = currentBreedList.find(
