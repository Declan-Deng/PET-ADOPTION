            ...
            <View style={styles.formSection}>
              ...
              {formData.petType === "other" ? (
                <>
                  <Button
                    mode="outlined"
                    onPress={() => setShowOtherPetTypeMenu(true)}
                    style={[styles.input, styles.selectButton]}
                    labelStyle={styles.selectButtonLabel}
                  >
                    {formData.otherType || "请选择动物类型"}
                  </Button>
                  <Modal
                    visible={showOtherPetTypeMenu}
                    transparent={true}
                    onRequestClose={() => setShowOtherPetTypeMenu(false)}
                    animationType="fade"
                  >
                      ...
                      <View style={styles.modalContent}>
                        <View style={styles.modalHeader}>
                          ...
                          <IconButton
                            icon="close"
                            size={24}
                            onPress={() => setShowOtherPetTypeMenu(false)}
                          />
                        </View>
                ...
                <>
                  ...
                  >
                    {formData.breed ||
                      `请选择${formData.petType === "cat" ? "猫" : "狗"}的品种`}
                  </Button>
                  <Modal
                    visible={showBreedMenu}
                    transparent={true}
                    onRequestClose={() => setShowBreedMenu(false)}
                    animationType="fade"
                  >
                    <View style={styles.modalOverlay}>
                      <View style={styles.modalContent}>
                        <View style={styles.modalHeader}>
                          ...
                          <IconButton
                            icon="close"
                            size={24}
                            onPress={() => setShowBreedMenu(false)}
                          />
                        </View>
                        <View style={styles.modalBody}>
                          <ScrollView>
