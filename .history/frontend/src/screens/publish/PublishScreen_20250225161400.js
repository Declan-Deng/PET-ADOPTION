...
const PublishScreen = ({ navigation }) => {
  ...
  const [otherTypeOpen, setOtherTypeOpen] = React.useState(false);
              ...
              {formData.petType === "other" ? (
                <>
                  <View style={styles.dropDownSection}>
                    <Text style={styles.dropDownLabel}>动物类型</Text>
                    <DropDownPicker
                      open={otherTypeOpen}
                      value={formData.otherType}
                      items={otherTypesList}
                      setOpen={setOtherTypeOpen}
                      setValue={(callback) => {
                        const value = callback(formData.otherType);
                ...
                <>
                  <View style={styles.dropDownSection}>
                    <Text style={styles.dropDownLabel}>品种</Text>
                    <DropDownPicker
                      open={breedOpen}
                      ...
                      setValue={(callback) => {
                        const value = callback(formData.breed);
