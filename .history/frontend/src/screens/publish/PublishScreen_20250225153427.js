...
const PublishScreen = ({ navigation }) => {
  ...
  // 处理其他宠物类型选择
  const handleOtherPetTypeSelect = (type) => {
    updateField("otherType", type);
    setShowOtherPetTypeDropDown(false);
  };
              ...
              {formData.petType === "other" ? (
                <>
                  <TextInput
                    ...
                    onPressIn={() => setShowOtherPetTypeDropDown(true)}
                    style={styles.input}
                    mode="outlined"
                    editable={false}
                        ...
                        <ScrollView>
                          {otherPetTypes.map((type) => (
                            <List.Item
                              ...
                              title={type.label}
                              onPress={() =>
                                handleOtherPetTypeSelect(type.label)
                              }
                            />
                          ))}
                        </ScrollView>
                ...
                <>
                  <TextInput
                    ...
                    onPressIn={() => setShowBreedDropDown(true)}
                    style={styles.input}
                    mode="outlined"
                    editable={false}
                    right={<TextInput.Icon icon="menu-down" />}
                        ...
                        <ScrollView>
                          {currentBreedList.map((item) => (
                            <List.Item
                              key={item.value}
                              title={item.label}
                              onPress={() => handleBreedSelect(item.value)}
                            />
                          ))}
                        </ScrollView>
                      </Dialog.ScrollArea>
