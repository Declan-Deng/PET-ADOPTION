  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <Animated.View
        ...
        style={[styles.headerContainer, { backgroundColor: "#FFF5F5" }]}
      >
        <Avatar.Icon
          size={80}
          icon="paw"
          style={[styles.logo, { backgroundColor: "#FFB6C1" }]}
          color="#FFF"
        />
      ...
      >
        ...
        <Card style={[styles.contactCard, { backgroundColor: "#F8F9FA" }]}>
          <Card.Content>
            {contactInfo.map((contact, index) => (
              <React.Fragment key={contact.title}>
                <Button
                  ...
                  style={[styles.contactButton, { borderColor: "#FFB6C1" }]}
                  labelStyle={[styles.contactButtonLabel, { color: "#666" }]}
                >
      ...
      >
        ...
        <Card style={[styles.aboutCard, { backgroundColor: "#F0F8FF" }]}>
          <Card.Content>
